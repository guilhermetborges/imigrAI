...
async def create_country(payload: CountryCreate, db: AsyncSession = Depends(get_db)) -> CountryRead:
...
async def get_country(country_id: UUID, db: AsyncSession = Depends(get_db)) -> CountryRead:
    repo = ImmigrationRulesRepository(db)
...
@router.post(
    "/programs", response_model=ImmigrationProgramRead, status_code=status.HTTP_201_CREATED
)
...
@router.get("/programs", response_model=list[ImmigrationProgramRead])
...
@router.get("/programs/{program_id}", response_model=ImmigrationProgramRead)
...
@router.patch("/programs/{program_id}", response_model=ImmigrationProgramRead)
...
@router.post(
    "/program-versions",
    response_model=ProgramVersionRead,
...
@router.get("/programs/{program_id}/versions", response_model=list[ProgramVersionRead])
...
@router.get("/program-versions/{program_version_id}", response_model=ProgramVersionRead)
...
@router.patch("/program-versions/{program_version_id}", response_model=ProgramVersionRead)
...
@router.post("/program-versions/{program_version_id}/activate", response_model=ProgramVersionRead)
...
@router.post("/rule-groups", response_model=RuleGroupRead, status_code=status.HTTP_201_CREATED)
...
@router.get(
    "/program-versions/{program_version_id}/rule-groups", response_model=list[RuleGroupRead]
)
...
@router.get("/rule-groups/{rule_group_id}", response_model=RuleGroupRead)
async def get_rule_group(rule_group_id: UUID, db: AsyncSession = Depends(get_db)) -> RuleGroupRead:
    repo = ImmigrationRulesRepository(db)
...
@router.patch("/rule-groups/{rule_group_id}", response_model=RuleGroupRead)
...
@router.post(
    "/rule-conditions", response_model=RuleConditionRead, status_code=status.HTTP_201_CREATED
)
...
@router.get("/rule-groups/{rule_group_id}/conditions", response_model=list[RuleConditionRead])
...
@router.get("/rule-conditions/{condition_id}", response_model=RuleConditionRead)
...
@router.patch("/rule-conditions/{condition_id}", response_model=RuleConditionRead)
...
@router.post("/rule-outcomes", response_model=RuleOutcomeRead, status_code=status.HTTP_201_CREATED)
...
@router.get("/rule-groups/{rule_group_id}/outcomes", response_model=list[RuleOutcomeRead])
...
@router.get("/rule-outcomes/{outcome_id}", response_model=RuleOutcomeRead)
async def get_rule_outcome(outcome_id: UUID, db: AsyncSession = Depends(get_db)) -> RuleOutcomeRead:
    repo = ImmigrationRulesRepository(db)
...
@router.patch("/rule-outcomes/{outcome_id}", response_model=RuleOutcomeRead)
